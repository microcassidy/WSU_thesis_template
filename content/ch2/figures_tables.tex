...
\begin{table}[tb]
\caption[A floating table]{A floating table.}\label{tab:esempio}
\centering
\begin{tabular}{ccc}
\toprule
name & weight & food \\ 
...
\begin{figure}[tb]
\centering 
\includegraphics[width=0.5\columnwidth]{content/ch2/images/galleria_stampe} 
...
\begin{figure}[tb]
\centering 
\includegraphics{content/ch2/images/some_vector_graphics} 
...
{\includegraphics[width=.45\columnwidth]{content/ch2/images/lorem}} \quad
\subfloat[Pan ma signo.]
{\label{fig:ipsum}%
\includegraphics[width=.45\columnwidth]{content/ch2/images/ipsum}} \\
\subfloat[Methodicamente o uno.]
{\includegraphics[width=.45\columnwidth]{content/ch2/images/dolor}} \quad
\subfloat[Titulo debitas.]
{\includegraphics[width=.45\columnwidth]{content/ch2/images/sit}}
