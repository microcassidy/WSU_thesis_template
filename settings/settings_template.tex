...
%		Thesis Settings
%
%		Base on the original EDOC Template
%		2011-2025
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{pgffor} % convenience looping across array elements
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \usepackage{fourier-otf} % Utopia font-typesetting including mathematical formula compatible with newer TeX-Distributions (>2010)
...
\titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    \node[yshift=-8cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
        \draw[fill=black] (0,7.5mm) rectangle(35.5mm,7.5mm+30pt);
        \node[anchor=north east,yshift=-73mm,xshift=34mm,minimum height=30mm,inner sep=0mm] at (current page.north west)
          % {\parbox[top][30mm][t]{30mm}{\raggedleft \rule{0cm}{0.6cm}\color{white}\chapterlabel}};
          {\parbox[top][30mm][t]{15mm}{\raggedleft \rule{0cm}{0mm}\color{white}\chapterlabel}};  %the empty rule is just to get better base-line alignment
        \node[anchor=north west,yshift=-72mm,xshift=37mm,text width=\textwidth,minimum height=30mm,inner sep=0mm] at (current page.north west)
...
\titleformat{\part}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    \node[anchor=north west,xshift=-65mm,yshift=-6.9cm-\value{myparts}*20mm] at (current page.north east) % for unknown reasons: 3mm missing -> 65 instead of 62
      {\begin{tikzpicture}[remember picture, overlay]
        \draw[fill=black] (0,1) rectangle(62mm,20mm);   % -\value{myparts}\unitlength
